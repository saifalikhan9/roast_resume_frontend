  ...
  return (
     <div className="space-y-6">
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground text-lg">Here&apos;s what our AI roaster thinks about your resume</p>
            </div>

            <Card className="bg-card border-border">
              <CardHeader className="flex flex-row items-center justify-between">
                <CardTitle className="text-card-foreground font-sans">Your Personalized Roast</CardTitle>
                <Button
                  variant="outline"
                  size="sm"
